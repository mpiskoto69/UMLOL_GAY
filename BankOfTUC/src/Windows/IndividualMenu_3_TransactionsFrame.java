...
public class IndividualMenu_3_TransactionsFrame extends JFrame implements ActionListener {
    ...
    private final JLabel title = new JLabel("Individual Menu 3");
    ...
    private static void styleBtn(JButton b, Font f, Border border) {
        ...
        b.addActionListener(null); // placeholder (θα μπει στο constructor με addActionListener(this))
    }
    ...
    public void actionPerformed(ActionEvent e) {
        ...
        if (src == btnDeposit) System.out.println("Deposit selected");
        if (src == btnWithdrawal) System.out.println("Withdrawal selected");
        if (src == btnTransfer) System.out.println("Transfer selected");
        if (src == btnPayment) System.out.println("Payment selected");
    }
}
